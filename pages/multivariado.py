...
TH = {
    "background": "#F2F0EB", "color": "#6E6D7A", "fontWeight": "700",
    "fontSize": "11px", "textTransform": "uppercase", "letterSpacing": "0.5px",
    "padding": "8px 12px", "borderBottom": "2px solid #E8E5DE", "textAlign": "left",
}
TD = {
    "padding": "9px 12px", "borderBottom": "1px solid #F0EDE8",
    "color": "#1E1E2E", "fontSize": "13px",
}
NOTE_RED = {
    "fontSize": "12px", "color": "#3D3D50", "lineHeight": "1.6",
    "padding": "10px", "background": "rgba(239,68,68,.05)",
    "borderRadius": "8px", "borderLeft": "3px solid #EF4444",
}
NOTE_GREEN = {
    "fontSize": "12px", "color": "#3D3D50", "lineHeight": "1.6",
    "padding": "10px", "background": "rgba(22,163,74,.05)",
    ...
    return html.Div([
        ...
        dbc.Row([
            ...
            dbc.Col(html.Div([
                ...
                html.Table([
                    html.Thead(html.Tr([
                        html.Th("Grupo",         style=TH),
                        html.Th("Estadístico A", style=TH),
                        html.Th("V. Crítico 5%", style=TH),
                        html.Th("Resultado",     style=TH),
                    ])),
                    html.Tbody([
                        html.Tr([
                            html.Td("Con fraude",  style=TD),
                            html.Td("698.82",      style=TD),
                            html.Td("0.785",       style=TD),
                            html.Td([
                                html.Span("✕ ", style={"color": A, "fontWeight": "800"}),
                                "Rechaza H₀",
                            ], style=TD),
                        ]),
                        html.Tr([
                            html.Td("Sin fraude",  style=TD),
                            html.Td("250,256.09",  style=TD),
                            html.Td("0.787",       style=TD),
                            html.Td([
                                html.Span("✕ ", style={"color": A, "fontWeight": "800"}),
                                "Rechaza H₀",
                            ], style=TD),
                          ...
                          "margin-block": "30px", "fontSize": "13px", }),

                html.Div(
                    "Con un nivel de confianza del 95%, el estadístico A supera el valor "
                    "crítico en ambos grupos. Se concluye que ninguna de las dos poblaciones "
            ...
            dbc.Col(html.Div([
                ...
                html.Table([
                    html.Thead(html.Tr([
                        html.Th("Parámetro", style=TH),
                        html.Th("Valor",     style=TH),
                    ])),
                    html.Tbody([
                        html.Tr([
                            html.Td("Prueba",         style=TD),
                            html.Td("Mann-Whitney U", style=TD),
                        ]),
                        html.Tr([
                            html.Td("Estadístico U",  style=TD),
                            html.Td("599,752,901.50", style=TD),
                        ]),
                        html.Tr([
                            html.Td("p-valor", style=TD),
                            html.Td([
                                html.Span("< 0.000001",
                ...
                html.Div(
                    "p-valor extremadamente pequeño (< 0.05). El valor de la transacción "
                    "no se comporta igual en operaciones fraudulentas y legítimas, lo que "
                    "constituye un indicio de dependencia entre ambas variables.",
                    style=NOTE_GREEN,
                ),
            ], style={**CARD, "height": "100%"}), md=6),
